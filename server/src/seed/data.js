...
export const buildSeedData = () => {
  ...
  const users = [
    ...
    { _id: 'user-fpo-puri', name: 'Pratima Mohanty', email: 'contact@maamangala.demo', phone: '9876501021', role: 'fpo_manager', organization: 'Maa Mangala Growers', location: 'Puri', verified: true },
    { _id: 'user-fpo-balasore', name: 'Niranjan Jena', email: 'office@subarnarekha.demo', phone: '9876501022', role: 'fpo_manager', organization: 'Subarnarekha Farmer Collective', location: 'Balasore', verified: true },
    ...
    { _id: 'user-driver-store', name: 'Sunita Barik', email: 'driver.store@kishanbhaiya.demo', phone: '9876501015', role: 'driver', organization: 'KISHAN BHAIYA Urban Delivery Pool', location: 'Bhubaneswar', verified: true },
  ...
  const sellers = [
    ...
    { id: 'seller-2', userId: 'user-fpo', name: 'Utkal Harvest FPO', type: 'FPO', location: 'Cuttack', address: 'CDA Sector 6, Cuttack, Odisha 753014', coordinates: coords.cuttack, contactName: 'Madhabi Sethi', contactPhone: '9876501004', contactEmail: 'fpo@kishanbhaiya.demo', rating: 4.8, reviews: 243, reliability: 98, completedOrders: 487, memberCount: 286, crops: ['Tomato', 'Rice', 'Potato'], officeHours: 'Mon–Sat · 9:00 AM–5:00 PM', image: image('photo-1500595046743-cd271d694d30') },
    { id: 'seller-3', userId: 'user-fpo-puri', name: 'Maa Mangala Growers', type: 'FPO', location: 'Puri', address: 'Sakhigopal Road, Puri, Odisha 752001', coordinates: coords.puri, contactName: 'Pratima Mohanty', contactPhone: '9876501021', contactEmail: 'contact@maamangala.demo', rating: 4.7, reviews: 98, reliability: 94, completedOrders: 176, memberCount: 164, crops: ['Mango', 'Banana', 'Vegetables'], officeHours: 'Mon–Sat · 9:30 AM–4:30 PM', image: image('photo-1472653525502-fc569e405a74') },
    { id: 'seller-4', userId: 'user-fpo-balasore', name: 'Subarnarekha Farmer Collective', type: 'FPO', location: 'Balasore', address: 'Station Bazaar, Balasore, Odisha 756001', coordinates: coords.balasore, contactName: 'Niranjan Jena', contactPhone: '9876501022', contactEmail: 'office@subarnarekha.demo', rating: 4.8, reviews: 181, reliability: 97, completedOrders: 302, memberCount: 218, crops: ['Onion', 'Paddy', 'Groundnut'], officeHours: 'Mon–Fri · 10:00 AM–5:00 PM', image: image('photo-1523741543316-beb7fc7023d8') },
