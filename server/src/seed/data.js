...
export const buildSeedData = () => {
  ...
  const users = [
    ...
    { _id: 'user-logistics', name: 'Sujit Behera', email: 'logistics@kishanbhaiya.demo', phone: '9876501005', role: 'logistics', organization: 'Kishan Bhaiya Logistics', location: 'Bhubaneswar', verified: true },
    { _id: 'user-admin', name: 'Priya Rath', email: 'admin@kishanbhaiya.demo', phone: '9876501006', role: 'admin', organization: 'Kishan Bhaiya', location: 'Bhubaneswar', verified: true },
    { _id: 'user-driver', name: 'Bijay Pradhan', email: 'driver.active@kishanbhaiya.demo', phone: '9876501007', role: 'driver', organization: 'Independent Driver', location: 'Cuttack', verified: true, currentShipmentId:'ship-driver-demo' },
    { _id: 'user-fleet', name: 'Sangram Logistics', email: 'fleet@kishanbhaiya.demo', phone: '9876501008', role: 'logistics_partner', organization: 'Sangram Rural Fleet', location: 'Bhubaneswar', verified: true },
  ...
  const vehicles = [
    ...
    { _id:'vehicle-3',driverUserId:'user-pending-driver',registration:'OD 33 T 4021',type:'Mahindra Bolero',capacity:1400,coldChain:false,status:'AVAILABLE' },{ _id:'vehicle-4',registration:'OD 15 N 7712',type:'Ashok Leyland Dost',capacity:1600,coldChain:false,status:'DELAYED' },
    { _id:'vehicle-driver-demo',driverUserId:'user-driver',registration:'OD 05 BP 8812',type:'Tata Ace EV',capacity:900,coldChain:false,status:'ASSIGNED',shipmentId:'ship-driver-demo' },
    { _id:'vehicle-fleet-bulk',driverUserId:'user-driver-bulk',registration:'OD 02 KB 2026',type:'Eicher Pro 3015',capacity:3500,coldChain:true,status:'AVAILABLE' }
  ];
