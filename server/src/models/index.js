...
const schemas = {
  User: new mongoose.Schema(
    {
      ...
      accountStatus: { type: String, enum: accountStatuses, index: true },
      verificationStatus: {
        type: String,
  ...
  UrbanStore: new mongoose.Schema(
    {
      _id: String,
      name: { type: String, required: true, index: true },
      ownershipType: {
        type: String,
        enum: ["GOVERNMENT", "FRANCHISE"],
        required: true,
        index: true,
      },
      operatorName: String,
  ...
  StoreInventory: new mongoose.Schema(
    {
      _id: String,
  ...
  ProduceLot: new mongoose.Schema(
    {
      _id: String,
      ...
      freshnessState: { type: String, index: true },
      location: point,
    },
    options,
  ),
  BulkRequirement: new mongoose.Schema(
    {
      _id: String,
  ...
  Negotiation: new mongoose.Schema(
    {
      _id: String,
  ...
  ExpectedHarvest: new mongoose.Schema(
    {
      _id: String,
      sellerId: { type: String, index: true },
      productId: String,
  ...
  HarvestReservation: new mongoose.Schema(
    {
      _id: String,
      harvestId: { type: String, index: true },
      buyerId: { type: String, index: true },
      quantity: Number,
      status: String,
    },
  ...
  QualityPassport: new mongoose.Schema(
    {
      _id: String,
      lotId: { type: String, unique: true, index: true },
      lotCode: String,
      status: String,
    },
    options,
  ...
  PriceSnapshot: new mongoose.Schema(
    {
      _id: String,
      productId: { type: String, index: true },
  ...
  Settlement: new mongoose.Schema(
    {
      _id: String,
      fpoId: { type: String, index: true },
      memberId: String,
      status: String,
    },
    options,
  ),
  RecurringRequirement: new mongoose.Schema(
    {
      _id: String,
  ...
  VerificationProfile: new mongoose.Schema(
    {
      _id: String,
  ...
  VerificationDocument: new mongoose.Schema(
    {
      _id: String,
      ownerId: { type: String, required: true, index: true },
      documentType: { type: String, required: true, index: true },
      documentNumberMasked: String,
      secureFileKey: { type: String, required: true },
      mimeType: String,
      size: Number,
      status: {
        type: String,
  ...
  VerificationReview: new mongoose.Schema(
    {
      _id: String,
      ...
      action: {
        type: String,
        required: true,
        enum: ["APPROVE", "REQUEST_CHANGES", "REJECT", "SUSPEND", "REACTIVATE"],
        index: true,
      },
      reasonCode: String,
      note: String,
  ...
  PlatformFeedback: new mongoose.Schema(
    {
      _id: String,
   ...
   */
  UploadedFile: new mongoose.Schema(
    {
      _id: String,
      ownerId: { type: String, required: true, index: true },
...
for (const name of [
  ...
  schemas[name] = new mongoose.Schema({ _id: String }, options);
...
export const collectionMap = {
  ...
  sellers: "Seller",
  products: "Product",
  urbanStores: "UrbanStore",
  storeInventories: "StoreInventory",
  lots: "ProduceLot",
  qualityPassports: "QualityPassport",
  ...
  shipments: "Shipment",
  members: "FPOMember",
  fpoMembershipRequests: "FPOMembershipRequest",
  ...
  rescueOffers: "RescueOffer",
  subFulfillments: "OrderSubFulfillment",
