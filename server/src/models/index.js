...
for (const name of ['Seller','FarmerProfile','FPOProfile','BusinessProfile','FPOMember','FPOMembershipRequest','InventoryMovement','RecurringRequirement','ShipmentStop','DriverProfile','CollectionHub','Vehicle','Payment','AuditLog','Aggregation','RescueOffer','OrderSubFulfillment']) schemas[name] = new mongoose.Schema({ _id:String }, options);
